In this tutorial, we'll combine everything we've learned so far and create some animations. Most of my games start as a circle bouncing around the screen, so this is more useful than it might seem!
